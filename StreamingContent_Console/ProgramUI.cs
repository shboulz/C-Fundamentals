...
namespace StreamingContent_Console
{
    public class ProgramUI
    {
        ...
        private void CreateNewContent()
        {
            ...
            Console.WriteLine("Welcome to you Streaming Content Creator Page!!");
            ...
            // the star rating we created was a double so we use double.Parse to convert user input from string to double!
        ...
        private void ShowAllContent()
        {
            ...
            {
                //this was created before private void DisplayContent(StreamingContent content) at the bottom on line 176 we cut paste it in line 176 and replaced it with DisplayContent(content); on line 157!
        ...
        private void ShowContentByTitle()
        {
            ...
            {
                // or we could do Console.WriteLine("Invalid Title. Could not find {title}");
